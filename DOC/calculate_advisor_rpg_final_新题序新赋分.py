...
配置版本：2026-09-11 新题序＋研究团队指定赋分
题序依据：10题筛选_小程序题目顺序.docx
赋分依据：《新10题赋分表 new.xlsx》工作表“10题赋分表_修订版”
...
ABCD,4,2,0,2,1,0,0,0,0,3
ABDC,3,2,1,2,2,0,1,0,3,4
ACBD,4,3,2,2,0,0,1,1,0,2
ACDB,2,4,3,1,0,0,1,2,1,1
ADBC,1,2,1,2,2,0,1,1,2,3
ADCB,1,3,3,1,1,1,3,2,1,1
BACD,2,2,0,4,2,0,0,0,2,2
BADC,1,1,0,4,3,0,2,0,2,4
BCAD,3,1,1,3,2,1,1,1,1,2
BCDA,1,1,1,3,2,3,1,2,0,3
BDAC,1,1,1,3,4,2,2,1,2,2
BDCA,0,0,1,3,3,3,0,2,1,2
CABD,4,2,3,2,0,1,2,2,0,1
CADB,2,3,4,1,0,1,4,3,1,0
CBAD,3,2,3,2,1,2,2,2,1,1
CBDA,1,1,3,2,2,4,2,3,0,2
CDAB,2,2,4,0,1,2,4,4,2,0
CDBA,1,2,4,1,2,3,1,4,2,2
DABC,1,2,2,2,3,3,2,2,1,2
DACB,0,2,3,0,2,2,3,3,2,1
DBAC,0,1,1,2,4,3,2,2,1,2
DBCA,0,1,2,2,3,4,1,3,2,2
DCAB,0,2,4,0,2,3,1,4,2,0
DCBA,0,1,3,1,2,4,1,4,4,2"""
