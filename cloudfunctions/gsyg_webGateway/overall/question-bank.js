...
const NEW_ITEMS = [
  ...
  {
    item_id: 'T12_COLOR', aliases: ['XXXX0114'], title: '相近颜色材料的不同理解', indicator: 'I5 对游戏材料的分析与投放',
    stem: '小班上学期，李老师在区域中投放了一组“停车场”游戏材料：磁性板上贴着一列圆形色卡，颜色依次为绿色、黄色、粉色、深蓝色、浅蓝色，旁边放着相同颜色的小汽车卡片，供幼儿自由选择、摆放和配对。李老师观察到，苗苗把深蓝色和浅蓝色的小汽车混在一起，统一停到“蓝色停车位”上。李老师问：“这两种蓝色车子的颜色一样吗？”苗苗看了看说：“一样呀，都是蓝色。”随后，李老师又发现还有两名幼儿也出现了类似的摆放方式。',
    options: {
      A: '将汽车卡片按照颜色一一对应摆好，请幼儿说说自己与老师的差异，帮助幼儿逐步意识到颜色不同。',
      B: '在幼儿继续摆放时，将深蓝和浅蓝的两辆小汽车并排放在一起，引导幼儿比较这两辆车哪里一样、哪里不一样，再请幼儿尝试按自己的发现重新停放。',
      C: '将深蓝、浅蓝色的色卡进行对比，请幼儿仔细观察，如果仍分辨不出，就按幼儿的摆法操作。',
      D: '幼儿混淆了深浅两种蓝色是材料投放不合理的原因，将浅蓝色色卡暂时撤下，请幼儿继续探索。'
    }
  },
  {
...
module.exports = { VERSION: 'TCIM-20题/2026-09-19', ITEMS, findItem };
