...
const ABILITY_MAP = {
  ...
  2: { item_id: 'Q2', item_title: '未参与小组建构', primary: 'D 支架策略与游戏推进', secondary: 'E 共同游戏组织' },
  3: { item_id: 'Q3', item_title: '材料选择无层次', primary: 'D 支架策略与游戏推进', secondary: 'C 观察诊断' },
  4: { item_id: 'Q4', item_title: '频繁求助', primary: 'C 观察诊断与介入时机', secondary: 'D 支架策略' },
  5: { item_id: 'Q5', item_title: '消防员救火开心', primary: 'A 游戏意义理解与儿童视角', secondary: 'B 价值平衡' },
  6: { item_id: 'Q6', item_title: '区域停留短', primary: 'C 观察诊断与介入时机', secondary: 'A 儿童视角' },
  7: { item_id: 'Q7', item_title: '飞行棋各走各的', primary: 'E 共同游戏组织与规则共建', secondary: 'B 规则平衡' },
  8: { item_id: 'Q8', item_title: '跳绳秩序混乱', primary: 'E 共同游戏组织与规则共建', secondary: 'B 安全秩序' },
  9: { item_id: 'Q9', item_title: '艾莎公主不运动', primary: 'D 支架策略与游戏推进', secondary: 'A 儿童视角/B 目标平衡' },
  10: { item_id: 'Q10', item_title: '引水难题未解', primary: 'C 观察诊断与介入时机', secondary: 'D 探究支架' }
};
...
const SCENARIO_FOLLOWUP_QUESTIONS = {
  1: ['这个情境里,孩子把篮球架变成玩水场地,你当时更关注他们的游戏兴趣、器械用途,还是安全与场地适宜性?', '如果既想保护孩子的探索兴趣,又要回应篮球架原本的运动功能,你觉得教师可以怎样衔接?'],
  2: ['睿睿离开了原来的搭桥计划去玩长条木板,你当时怎样理解他的行为:是偏离共同任务,还是出现了新的游戏线索?', '面对共同建构计划和幼儿临时兴趣之间的变化,你觉得教师什么时候应该介入,什么时候可以继续观察?'],
  3: ['浩浩反复选择一星任务卡时,你当时更想尊重他的自主选择,还是推动他尝试更有挑战的任务?', '你觉得教师应该怎样判断幼儿是需要安全感、缺少挑战意识,还是任务卡呈现方式本身需要调整?'],
  4: ['小明一边说不会搭,一边又能继续加高房子,你当时怎样判断他真正需要的帮助是什么?', '面对幼儿反复求助,你觉得教师怎样支持,既不替代幼儿完成,又能帮助他继续推进游戏?'],
  5: ['阳阳说娃娃家着火了很开心时,你当时更关注真实火灾的危险教育,还是先理解他在游戏里的开心来自哪里?', '你觉得教师怎样回应,既不否定幼儿的游戏体验,又能引导他们理解真实火灾的意义?'],
  6: ['瑶瑶在多个区域快速转换时,你当时会先把它看作注意力不集中、规则问题,还是一种探索不同材料的方式?', '如果你在现场,你会先观察哪些信息来判断是否需要介入?'],
  7: ['两个孩子各走各的棋时,你当时更关注共同游戏规则的建立,还是先让他们体验这种玩法会带来什么问题?', '你觉得教师怎样帮助幼儿从各玩各的,过渡到真正的共同游戏?'],
  8: ['跳绳现场混乱且可能碰撞时,你当时更倾向于立即组织秩序,还是先让幼儿自己发现问题?', '在安全风险和幼儿自主制定规则之间,你觉得教师应该怎样把握介入时机?'],
  9: ['几个女孩在户外运动时间玩艾莎公主时,你当时更关注运动目标,还是关注她们正在生成的角色游戏兴趣?', '如果要把艾莎公主游戏和运动活动连接起来,你觉得教师可以怎样做才不显得生硬?'],
  10: ['孩子们引水失败、兴趣减弱时,你当时更倾向于直接示范方法,还是继续支持他们自己发现水流受阻的原因?', '你觉得教师怎样提供支架,既能帮助问题解决,又保留幼儿继续探究的空间?']
};
